...
const TheaterSidebar = ({ sidebarOpen, setSidebarOpen, sidebarCollapsed, currentPage = 'dashboard' }) => {
  ...
  const allNavigationItems = [
    ...
    { id: 'product-types', icon: 'productname', label: 'Product Name', path: effectiveTheaterId ? `/theater-product-types/${effectiveTheaterId}` : '/theater-product-types' },
    ...
    { id: 'staff-order-history', icon: 'orderhistory', label: 'My Orders', path: effectiveTheaterId ? `/staff-order-history/${effectiveTheaterId}` : '/staff-order-history' },
